...
export type ValidationResult = { [key: string]: ValidationResult } | string | null | undefined;
 ...
 */
export type PRecordErrors<T extends Record<string, any>> = PRecord<T, ValidationResult>;
